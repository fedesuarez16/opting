...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen md:h-screen flex flex-col md:flex-row md:overflow-hidden bg-gray-100">
      ...
      <a
        href="mailto:soporte@opting.com?subject=Solicitud de Soporte"
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-orange-500 hover:bg-orange-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 group"
